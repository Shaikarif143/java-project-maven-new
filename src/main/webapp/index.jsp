...
<head>
    ...
    <!-- ------------------ Title ------------------ -->
    <title>Disney+ Hotsrtar - Watch TV Shows Online</title>
        ...
        <div class="carousel">
            <!-- <div class="slider">
                <div class="slide-content">
                    ...
                    <p class="movie-des">Lorem ipsum WEB, sit amet consectetur adipisicing elit. Quam distinctio molestiae quis praesentium cum obcaecati eveniet voluptates exercitationem eum accusantium.</p>
                </div>
